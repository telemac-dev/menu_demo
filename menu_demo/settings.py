...
SECRET_KEY = 'django-insecure-ul4w(l@i^hs@8*&k)*7v)fm3$7m^10+lt9c--m7=79fl*_x-j%'
...
INSTALLED_APPS = [
    ...
    'core',  # Nosso app
    'user_management',  # app para gerenciar os usuario
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.menu_processor',  # Nosso context processor
            ],
        },
    },
]
